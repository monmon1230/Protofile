  ...
  return (
    <motion.div
      ...
      className="w-full max-w-2xl  
                bg-gradient-to-br from-indigo-900 via-black to-purple-900 border-2 
    ...
    >
      ...
      >
        ...
        {/* Skills */}
        <div className="mt-2">
          <h3 className="text-white font-semibold mb-2 text-lg">Skills :</h3>
          <div className="flex flex-wrap justify-center-safe gap-4">
            {[
              { name: "React", color: "bg-purple-900" },
