          ...
          <Row className="flex flex-wrap justify-center mt-3">
            ...
            <Col xs={12} md={8} className=" flex flex-wrap justify-start text-white text-center md:text-left">
              ...
              <p className=" flex flex-wrap text-start">
                Frontend Developer with a strong focus on creating clean, responsive, and user-friendly web applications.

I work mainly with React and modern JavaScript, building interactive interfaces that provide smooth user experiences. I care about code quality, performance, and scalable design.

Always learning, improving, and aiming to build products that make a real impact.
              </p>
            </Col>
          </Row>
        </motion.div>
...
<Row className="flex flex-wrap justify-content-center m-3 pb-5">
  <Col xs={12} md={6} lg={4} className="mb-4">
    <CardCom
      img={SmartBrain}
      Title="SmartBrain : AI Face Detection App"
